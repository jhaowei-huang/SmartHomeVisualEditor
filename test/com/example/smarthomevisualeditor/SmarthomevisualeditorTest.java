package com.example.smarthomevisualeditor;
 ...
 */
public class SmarthomevisualeditorTest extends TestBenchTestCase {
    @Rule
    ...
    private void openTestUrl() {
        getDriver().get("http://localhost:8080/SmartHomeVisualEditor");
    }
